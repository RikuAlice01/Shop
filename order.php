						...
						echo"<table name='color'>";	
							echo"<tr>";
								...
								if($color=='Blue'){
									...
									echo "<div class='button button_e' id='color'><center>Blue</center>";
									echo "</div>";				
									echo"</a>";									
									}else{
								...
								if($color=='Red'){
									...
									echo "<div class=' button button_e' id='color'><center>Red</center>";
									echo "</div>";				
									echo"</a>";

								}else{
									echo "<a class='red_button_css' id='blue_button' href='index.php?color=Red&alcohol=$alcohol&exb=$exb'>";
								...
								if($color=='Green'){
									...
									echo "<div class='button button_e' id='color'><center>Green</center>";
									echo "</div>";				
									echo"</a>";
								}else{
						...
						echo"<table name='alcohol'>";	
							...
							echo"<td>";
								if($exb!=1){
									...
									echo "<div class='button_e button button_h' id='alcohol'><center>Exigent</center>";
									echo "</div>";				
									echo"</a>";
								}else{
									echo "<a class='alcohol_a' id='alcohol_button' href='index.php?color=$color&alcohol=$alcohol&exb=Y'>";
									echo "<div class='alcohol button button_h' id='alcohol'><center>Exigent</center>";
									echo "</div>";				
									echo"</a>";									
								}	
							echo"</td>";						
